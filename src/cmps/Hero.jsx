      ...
      <div className="mobile-layout">
        <div className="text-content">
          ...
          <p className="font-Gilmer-Light pre-line">
            I'm a Frontend / Full-Stack Developer with hands-on experience since
            October 2023, specializing in building seamless and intuitive user
            experiences.
            <br />I leverage modern technologies — including{" "}
            <span className="font-Gilmer-Bold">
              ReactJS, Vue, React Native and NodeJS
            </span>{" "}
            — to develop high-quality, dynamic web applications.
            <br />
            My focus is on delivering clean, efficient, and scalable solutions,
            and I take pride in leading development efforts to drive impactful
            results.
          </p>
        </div>
